...
[HarmonyPatch]
internal static class CustomModifierUiRefreshPatch
{
	[CompilerGenerated]
	private sealed class _003CTargetMethods_003Ed__0 : IEnumerable<MethodBase>, IEnumerable, IEnumerator<MethodBase>, IEnumerator, IDisposable
	{
		...
		private Type _003CcustomRunScreenType_003E5__1;
		...
		{
			_003CcustomRunScreenType_003E5__1 = null;
			_003C_003Es__2 = null;
		...
		private bool MoveNext()
		{
			...
			_003C_003E1__state = -1;
			_003CcustomRunScreenType_003E5__1 = RuntimeTypeResolver.FindType("MegaCrit.Sts2.Core.Nodes.Screens.CustomRun.NCustomRunScreen") ?? RuntimeTypeResolver.FindTypeByName("NCustomRunScreen");
			if (_003CcustomRunScreenType_003E5__1 == null)
			{
				return false;
			}
			_003C_003Es__2 = new string[5] { "OnModifiersListChanged", "PlayerChanged", "RefreshButtonSelectionForPlayer", "InitializeMultiplayerAsHost", "InitializeMultiplayerAsClient" };
			_003C_003Es__3 = 0;
			goto IL_010a;
			IL_010a:
			if (_003C_003Es__3 < _003C_003Es__2.Length)
			{
				...
				_003Cmethod_003E5__5 = AccessTools.Method(_003CcustomRunScreenType_003E5__1, _003CmethodName_003E5__4, (Type[])null, (Type[])null);
	...
	private static void Postfix(object __instance, MethodBase __originalMethod)
	{
		...
		{
			if (__originalMethod.Name.Contains("Host"))
			{
				MultiplayerReflection.MarkHost();
			}
			else if (__originalMethod.Name.Contains("Client"))
			{
				MultiplayerReflection.MarkClient();
			}
			object? obj = AccessTools.Field(__instance.GetType(), "_modifiersList")?.GetValue(__instance);
			NCustomRunModifiersList val = (NCustomRunModifiersList)((obj is NCustomRunModifiersList) ? obj : null);
			if (val != null)
			{
				MoreRulesUi.Refresh((Control)(object)val);
			}
		}
	}
}
