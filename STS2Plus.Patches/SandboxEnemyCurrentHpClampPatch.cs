...
[HarmonyPatch]
internal static class SandboxEnemyCurrentHpClampPatch
{
	private static MethodBase? TargetMethod()
	{
		Type creatureRuntimeType = GameReflection.CreatureRuntimeType;
		return (creatureRuntimeType == null) ? null : AccessTools.Method(creatureRuntimeType, "SetCurrentHpInternal", (Type[])null, (Type[])null);
	}
